...
begin
 ...
 image4.Canvas.Pie(136,40,144,280,144,160,136,160);
...
str:='C:\Users\MVTU\Desktop\мвту\Листинг\'+inttostr(myMonth)+'.'+inttostr(myYear);
...
try
  ...
  if per>85 then  begin
   x1:=260;                       //координаты для отрисовки крайнего положения
   x2:=20;                       //координаты для отрисовки крайнего положения
  end;
	if per>120 then  begin
   per:=120;												//ограничиваем максимумом в 120 гардусов
  end;
	if per<0 then  begin
